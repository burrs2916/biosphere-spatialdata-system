...
#[tauri::command]
pub fn get_all_component_plugins(
    state: State<'_, ComponentPluginState>,
) -> Result<Vec<ComponentPlugin>, AppError> {
    ComponentPluginRepository::get_all_plugins(&state.db)
}

#[tauri::command]
pub fn get_enabled_component_plugins(
    state: State<'_, ComponentPluginState>,
) -> Result<Vec<ComponentPlugin>, AppError> {
...
#[tauri::command]
pub fn get_component_plugin_by_type(
    state: State<'_, ComponentPluginState>,
    plugin_type: String,
) -> Result<Option<ComponentPlugin>, AppError> {
    ComponentPluginRepository::get_plugin_by_type(&state.db, &plugin_type)
}

#[tauri::command]
pub fn create_component_plugin(
    state: State<'_, ComponentPluginState>,
    payload: CreateComponentPluginPayload,
) -> Result<ComponentPlugin, AppError> {
    ComponentPluginRepository::create_plugin(&state.db, &payload)
}

#[tauri::command]
pub fn update_component_plugin(
    state: State<'_, ComponentPluginState>,
...
#[tauri::command]
pub fn delete_component_plugin(
    state: State<'_, ComponentPluginState>,
    id: String,
) -> Result<(), AppError> {
...
#[tauri::command]
pub fn toggle_component_plugin(
    state: State<'_, ComponentPluginState>,
    id: String,
    enabled: bool,
) -> Result<(), AppError> {
...
#[tauri::command]
pub fn get_component_categories(
    state: State<'_, ComponentPluginState>,
...
#[tauri::command]
pub fn create_component_category(
    state: State<'_, ComponentPluginState>,
...
#[tauri::command]
pub fn delete_component_category(
    state: State<'_, ComponentPluginState>,
    id: String,
) -> Result<(), AppError> {
