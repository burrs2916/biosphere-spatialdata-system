...
export function registerBuiltinComponents(): void {
  componentRegistry.register({
    ...
    configSchema: [
      ...
      { key: "fontSize", label: "字号", type: "number", min: 8, max: 200, group: "排版" },
      ...
      { key: "lineHeight", label: "行高", type: "number", min: 1, max: 3, step: 0.1, group: "排版" },
      { key: "letterSpacing", label: "字间距", type: "number", min: 0, max: 20, step: 0.5, group: "排版" },
      ...
      { key: "textShadowBlur", label: "阴影模糊", type: "number", min: 0, max: 20, group: "装饰", hidden: (c) => !c.textShadowEnabled },
      { key: "textShadowOffsetX", label: "阴影X偏移", type: "number", min: -10, max: 10, group: "装饰", hidden: (c) => !c.textShadowEnabled },
      { key: "textShadowOffsetY", label: "阴影Y偏移", type: "number", min: -10, max: 10, group: "装饰", hidden: (c) => !c.textShadowEnabled },
      ...
      { key: "backgroundOpacity", label: "背景透明度", type: "slider", min: 0, max: 100, step: 5, group: "背景", hidden: (c) => !c.backgroundEnabled },
      { key: "borderEnabled", label: "边框", type: "toggle", group: "背景" },
      { key: "borderColor", label: "边框颜色", type: "color", group: "背景", hidden: (c) => !c.borderEnabled },
      { key: "borderWidth", label: "边框宽度", type: "number", min: 1, max: 10, group: "背景", hidden: (c) => !c.borderEnabled },
      { key: "borderRadius", label: "圆角", type: "number", min: 0, max: 50, group: "背景" },
      { key: "padding", label: "内边距", type: "number", min: 0, max: 40, group: "背景" },
      ...
      { key: "animationDuration", label: "入场动画时长(ms)", type: "number", min: 100, max: 5000, step: 100, group: "动画", hidden: (c) => c.animation === "none" },
      ...
      { key: "loopAnimationDuration", label: "循环动画时长(ms)", type: "number", min: 500, max: 10000, step: 100, group: "动画", hidden: (c) => c.loopAnimation === "none" },
      ...
      { key: "marqueeSpeed", label: "跑马灯速度(ms)", type: "number", min: 1000, max: 20000, step: 500, group: "动画", hidden: (c) => c.loopAnimation !== "marquee" },
    ],
  });
  ...
  componentRegistry.register({
    ...
    configSchema: [
      ...
      { key: "precision", label: "小数位数", type: "number", group: "显示", min: 0, max: 6, defaultValue: 1, hidden: (c) => !c.dataSourceId },
      ...
      { key: "fontSize", label: "数值字号", type: "number", group: "样式", min: 12, max: 72, defaultValue: 28 },
      { key: "titleFontSize", label: "标题字号", type: "number", group: "样式", min: 8, max: 24, defaultValue: 11 },
      { key: "backgroundColor", label: "背景色", type: "color", group: "样式" },
      { key: "borderRadius", label: "圆角", type: "number", group: "样式", min: 0, max: 50, defaultValue: 4 },
      { key: "padding", label: "内边距", type: "number", group: "样式", min: 0, max: 40, defaultValue: 12 },
